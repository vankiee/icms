...
myconn = mysql.connector.connect(host="localhost", user="root", passwd="rhmEzhFJ", database="project")
now = datetime.now()
...
layout =  [
    [sg.Text('Setting (Press \'Exit\' to leave)', size=(23,1), font=('Any',16),text_color='Yellow' ,justification='left')],
...
cap.release()
if notlogin == False:
    os.system('python gui.py '+str(result[0])+' '+current_time+' '+date)
os.system('python faces_gui.py')
